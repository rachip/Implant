...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchActivityBtn1 = (Button) findViewById(R.id.dev_config_link);
        switchActivityBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(getApplicationContext(), dev_config.class);
                // disable default animation for new intent
                startActivity(intent1);
            }
        });

        switchActivityBtn1 = (Button) findViewById(R.id. AnalysisReportsBu);
        switchActivityBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(getApplicationContext(), AnalysisReports.class);
                // disable default animation for new intent
                startActivity(intent1);
            }
        });
